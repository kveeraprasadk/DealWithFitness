		...
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse justify-content-between"
				...
				<div class="navbar-nav ml-auto">
					...
					<a href="Trainer.jsp" class="nav-item nav-link">Trainer</a> <a
						href="AdminLogin.jsp" class="nav-item nav-link active">Admin</a>
				</div>
			</div>
		</div>
	</div>
	...
	<div class="page-header">
		<div class="container">
			<div class="row">
				...
				<div class="col-12">
					<a href="index.jsp">Home</a> <a href="">Admin</a>
				</div>
			</div>
		</div>
	</div>
			...
			<div class="container">
				<div class="row">
					<div class="col-sm-7 text">
						...
						<h1>
							<strong>DealWithFitness</strong> Admin Login Form
						</h1>
						<div class="description">
							<p>
								Please provide your Username and Password details to Login as
								Administrator in <b>DealWithFitness</b>.
							</p>
