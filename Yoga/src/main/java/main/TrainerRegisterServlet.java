...
public class TrainerRegisterServlet extends HttpServlet {
	...
	/*	String monthlyfees=request.getParameter("formmonthlyfees1");
		String classlevel=request.getParameter("formclasslevel1");
		String from1=request.getParameter("formfrom1");
		String to1=request.getParameter("formto1");
		
		String expertise2=request.getParameter("formexpertise2");
		String monthlyfees2=request.getParameter("formmonthlyfees2");
		String classlevel2=request.getParameter("formclasslevel2");
		String from2=request.getParameter("form-from2");
		String to2=request.getParameter("form-to2");
		
		String expertise3=request.getParameter("formexpertise3");
		String monthlyfees3=request.getParameter("formmonthlyfees3");
		String classlevel3=request.getParameter("formclasslevel3");
		String from3=request.getParameter("form-from3");
		String to3=request.getParameter("form-to3");
	...
	//	String schedule7to9=request.getParameter("flexCheckDefaultschms7to9");
		...
		String schedule,schedule2,schedule3;
		schedule=from1+" to "+to1;
		if(from2.length()>0 && to2.length()>0)
		{			
			schedule2=from2+" to "+to2;
		}else{
			schedule2=" ";
			classlevel2=" ";
			monthlyfees2=" ";
		...
		if(from3.length()>0 && to3.length()>0)
		{
			...
			schedule3=from3+" to "+to3;
		}else{
			schedule3=" ";
			classlevel3=" ";
			monthlyfees3=" ";
			expertise3=" ";
			System.out.println("sc3:"+schedule3);
		}
 ...
 /*       System.out.println("path:"+request.getContextPath()+"/target/Yoga/img/" + fileName1);
      ...
      //      String query = "insert into trainertemptable(trainername,traineremail,experience,qualification,expertise,classlevel,monthlyfees,schedules,expertise2,classlevel2,monthlyfees2,schedules2,expertise3,classlevel3,monthlyfees3,schedules3,aboutyourself,photoname,photo,creationtime,certificate1,certificate1filename,certificate2,certificate2filename,certificate3,certificate3filename) values (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)"; //Insert user details into the table 'USERS'
                String query = "insert into trainertemptable(trainername,traineremail,experience,qualification,expertise,aboutyourself,photoname,photo,creationtime,certificate1,certificate1filename,certificate2,certificate2filename,certificate3,certificate3filename) values (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)"; //Insert user details into the table 'USERS'
