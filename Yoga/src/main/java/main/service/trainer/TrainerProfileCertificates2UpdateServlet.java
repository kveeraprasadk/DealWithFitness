...
/**
 * Servlet implementation class TrainerProfileCertificates2UpdateServlet
 */
@WebServlet("/certificate2update")
@MultipartConfig(maxFileSize = 1048576) // upload file's size up to 1MB(1048576 bytes binary)
public class TrainerProfileCertificates2UpdateServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Part certificate1 = request.getPart("form-certificate2-update");
		 ...
		 try
	        {
	            ...
	            String query = "update trainerregister set certificate2=?,certificate2filename=? where traineremail=?";
