...
public class TrainerProfileDetailsUpdateServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		/*
		 * String monthlyfees=(String)request.getParameter("monthlyfees"); String
		 * schedule=(String)request.getParameter("schedule"); String
		 * classlevel=(String)request.getParameter("classlevel");
		 * 
		 * String expertise2=(String)request.getParameter("expertise2"); String
		 * monthlyfees2=(String)request.getParameter("monthlyfees2"); String
		 * schedule2=(String)request.getParameter("schedule2"); String
		 * classlevel2=(String)request.getParameter("classlevel2");
		 * 
		 * String expertise3=(String)request.getParameter("expertise3"); String
		 * monthlyfees3=(String)request.getParameter("monthlyfees3"); String
		 * schedule3=(String)request.getParameter("schedule3"); String
		 * classlevel3=(String)request.getParameter("classlevel3");
		 */
		...
		try {
			...
			// String query = "update trainerregister set
			// trainername=?,experience=?,qualification=?,expertise=?,schedules=?,classlevel=?,monthlyfees=?,expertise2=?,schedules2=?,classlevel2=?,monthlyfees2=?,expertise3=?,schedules3=?,classlevel3=?,monthlyfees3=?,aboutyourself=?
			// where traineremail=?";
			...
			if (i != 0) { // Just to ensure data has been inserted into the database
				...
				// forwards to the message page
				// getServletContext().getRequestDispatcher("/Trainer.jsp").forward(request,
				// response);
			}
