...
/**
 * Servlet implementation class TrainerProfileCertificates3UpdateServlet
 */
@WebServlet("/certificate3update")
@MultipartConfig(maxFileSize = 1048576) // upload file's size up to 1MB(1048576 bytes binary)
public class TrainerProfileCertificates3UpdateServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Part certificate1 = request.getPart("form-certificate3-update");
		 ...
		 try
	        {
	            ...
	            String query = "update trainerregister set certificate3=?,certificate3filename=? where traineremail=?";
