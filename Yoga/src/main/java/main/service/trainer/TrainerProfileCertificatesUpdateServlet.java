...
/**
 * Servlet implementation class TrainerProfileCertificatesUpdateServlet
 */
@WebServlet("/addcertificates")
@MultipartConfig(maxFileSize = 1048576) // upload file's size up to 1MB(1048576 bytes binary)
public class TrainerProfileCertificatesUpdateServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Part certificate1 = request.getPart("form-certificate1-add");
		...
		Part certificate2 = request.getPart("form-certificate2-add");
		...
		Part certificate3 = request.getPart("form-certificate3-add");
