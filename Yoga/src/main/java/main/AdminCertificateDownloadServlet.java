...
/**
 * Servlet implementation class AdminCertificateDownloadServlet
 */
public class AdminCertificateDownloadServlet extends HttpServlet {
		 ...
		 String tid = (String)request.getParameter("user");
	        ...
	        try {
	           ...
	           conn=DBConnection.createConnection();
	            ...
	            String sql = "SELECT * FROM trainerregister WHERE traineremail = ? and photoname=?";
	            ...
	            if (result.next()) {
	                ...
	                String fileName = result.getString("photoname");
