...
/**
 * Servlet implementation class TrainersListOptionalServlet
 */
@WebServlet(name = "/TrainersListOptionalServlet", urlPatterns = "/expertiselist")
public class TrainersListOptionalServlet extends HttpServlet {
...
// Closing the Resources
			...
			request.getRequestDispatcher("/classexp.jsp").forward(request, response);
