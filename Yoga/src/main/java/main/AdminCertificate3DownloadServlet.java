...
/**
 * Servlet implementation class AdminCertificate3DownloadServlet
 */
public class AdminCertificate3DownloadServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
           ...
           conn=DBConnection.createConnection();
            ...
            String sql = "SELECT * FROM trainerregister WHERE traineremail = ? and certificate3filename=?";
            ...
            if (result.next()) {
                ...
                String fileName = result.getString("certificate3filename");
                Blob blob = result.getBlob("certificate3");
