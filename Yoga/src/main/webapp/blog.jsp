...
<html lang="en">
    ...
    <body>
        ...
        <div class="navbar navbar-expand-lg bg-dark navbar-dark">
            <div class="container-fluid">
                <a href="index.html" class="navbar-brand">dealwithfitness <span> </span></a>
                ...
                <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                    <div class="navbar-nav ml-auto">
                        <a href="./Trainers" class="nav-item nav-link ">Home</a>
        ...
        <div class="page-header">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <h2>DealWithFitness Blog</h2>
                    </div>
                    <div class="col-12">
                        <a href="">Home</a>
                        <a href="">DealWithFitness Blog</a>
                    </div>
                </div>
            </div>
        </div>
