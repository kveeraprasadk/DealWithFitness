function Whoami() {
	...
	self.whitelistedPages = ["index.jsp","indexnew.jsp","CommentsView","TermsAndConditions.jsp","Trainer.jsp","TrainerRegisterServlet","trainerdetails.jsp","viewstories.jsp","AdminLogin.jsp"];
